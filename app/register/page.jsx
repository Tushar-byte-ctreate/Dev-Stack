...
const handleSubmit =async (e)=>{
  ...
  const responce =  await fetch('/api/user/register',{
    ...
    if (responce.ok) return router.push('/login')
  ...
  return (
    ...
    <div class="flex min- overflow-hidden">
        <div class="relative flex-1 hidden w-0 overflow-hidden lg:block">
            <Image width={700} height={605} classNmae="absolute inset-0 object-cover w-full h-full bg-black" src="/assets/login.svg" alt=""/>
        </div>
        <div class="flex flex-col justify-center flex-1 px-4 py-12 overflow-hidden sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div class="w-full max-w-xl mx-auto lg:w-96">
                <div>
                    <a href="./index.html" class="text-blue-600 text-medium">Dev Stack</a>
                ...
                <div class="mt-8">
                    <div class="mt-6">
                        ...
                        <div>
                                ...
                                <div class="mt-1">
                                    <input onChange={(e)=> setUserData({...userData,name:e.target.value})} id="name" name="name" type="text" autocomplete="name" required="" placeholder="Your Name" class="block w-full px-5 py-3 text-base text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transform border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300"/>
                                </div>
                            </div>
                            <div>
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="mt-1">
                                    <input onChange={(e)=> setUserData({...userData,password:e.target.value})}  id="password" name="password" type="password" autocomplete="current-password" required="" placeholder="Your Password" class="block w-full px-5 py-3 text-base text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transform border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300"/>
                                </div>
                            </div>
